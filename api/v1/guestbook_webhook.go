...
// +kubebuilder:webhook:path=/mutate-webapp-my-domain-v1-guestbook,mutating=true,failurePolicy=fail,groups=webapp.my.domain,resources=guestbooks,verbs=create;update,versions=v1,name=webapp.my.domain,sideEffects=None,admissionReviewVersions=v1
...
// +kubebuilder:webhook:verbs=create;update;delete,path=/validate-webapp-my-domain-v1-guestbook,mutating=false,failurePolicy=fail,groups=webapp.my.domain,resources=guestbooks,versions=v1,name=webapp.my.domain,sideEffects=None,admissionReviewVersions=v1
